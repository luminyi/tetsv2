                    ...
                    <div class="widget-box-green">
                        <div class="widget-header header-color-green">
                            ...
                            @elseif(session('role')=='院级')
                                ...
                                <h5 class="bigger lighter">{{Auth::User()->unit}}理论课授课总体评价</h5>
                            @elseif(session('role')=='小组长')
                                <h5 class="bigger lighter">{{Auth::User()->group}}理论课授课总体评价</h5>
                            @endif
                        </div>
                ...
                <div id="minisize" class="col-xs-6 col-sm-6">
                    <div class="widget-box-red">
                        <div class="widget-header header-color-red">
                            @if(session('role')=='校级'||session('role')=='大组长')
                                <h5 class="bigger lighter">理论课听课总体评价</h5>
                            @elseif(session('role')=='院级')
                                <h5 class="bigger lighter">{{Auth::User()->unit}}理论课听课总体评价</h5>
                            @elseif(session('role')=='小组长')
                                <h5 class="bigger lighter">{{Auth::User()->group}}理论课听课总体评价</h5>
                            @endif
                        </div>
...
<script src="js/TheoryStatistic.js"></script>
