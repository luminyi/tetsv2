<table data-toggle="table" id="UndoTable"
    ...
    <tr>
        ...
        <th data-field="state" data-halign="center" data-align="center"
            data-formatter="Coordinate" data-events="actionEvents" >协调状态</th>
