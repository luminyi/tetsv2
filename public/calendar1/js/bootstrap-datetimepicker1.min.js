(function (a) {
    ...
    var i = function (l, k) {
        ...
        this.component = this.element.is(".date") ? (this.bootcssVer == 3 ? this.element.find(".input-group-addon .glyphicon-th, .input-group-addon .glyphicon-time, .input-group-addon .glyphicon-remove, .input-group-addon .glyphicon-calendar1, .input-group-addon .fa-calendar1, .input-group-addon .fa-clock-o").parent() : this.element.find(".add-on .icon-th, .add-on .icon-time, .add-on .icon-calendar1, .add-on .fa-calendar1, .add-on .fa-clock-o").parent()) : false;
